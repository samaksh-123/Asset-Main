...
//         `http://localhost:5000/api/assets/generate-code/${selectedType.toUpperCase()}`
//       );
//       setForm(prev => ({ ...prev, assetCode: res.data.code }));
//     } catch (err) {
//       console.error('Error fetching asset code', err);
//     }
//   }
// };
...
//   const handleSubmit = async () => {
//     try {
//       await addAsset({ ...form, issued: false });
//       alert('Asset added');
//       setForm({
//         assetCode: '',
//         type: '',
...
//           <input type="text" name="assetCode" value={form.assetCode} readOnly />
